...
import ecomerce_logo from "../../../../../assets/images/rose-shape.svg";
                ...
                <div className="container">
                    <Flex justify="space-between" align="center" className={styles["header__top-inner"]}>
                        <div className={styles.header__desc}>
                            PXT - Shop bán đồ làm đẹp, dưỡng da 
                        </div>
                        <div className={styles.header__contact}>
                            <ul>
                                <li>
                                    <i className="fa-solid fa-envelope"></i> <span>phanxuanthai2004@pxt.com</span>
                                </li>
                                <li>
                                    <i className="fa-solid fa-phone"></i> <span>083467417</span>
                                </li>
            ...
            <div className={styles.header__main}>
                <Flex className="container" justify="space-between" align="center">
                    <div className={styles.header__logo}>
                        ...
                        <span className={styles["header__logo-title"]}>PXT</span>
                    </div>
